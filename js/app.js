  ...
  productDetailEl.innerHTML = `
    <div class="space-y-4">
      <div class="overflow-hidden rounded-3xl bg-slate-100">
        <img src="${product.foto_url}" alt="Foto ${product.nama_produk}" class="h-72 w-full object-cover" onerror="this.src='https://via.placeholder.com/640x360?text=Gambar+tidak+tersedia'" />
      </div>
      <div class="space-y-3">
        <div class="flex items-center justify-between gap-4">
          <div>
